...
- `docs/layers/L35-fuzzy-resonance.md` — нечёткий профиль тантры (lucky_corridor / stability_braid / chaotic_bridge) для UI и агентов, чтобы видеть «карту удачи/хаоса» поверх числовых метрик.
