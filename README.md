...
- Примеры: `examples/ontogenesis_watch.js` (живой пульс), `examples/ontogenesis_metrics.js` (быстрый расчёт L_volatility / S_growth / C_switches), `examples/ontogenesis_l4_watch.js` (L4 mastery/skills/apprentice фокус, цветовая подсветка). Быстрый запуск L4-пульса: `npm run watch:l4`.
